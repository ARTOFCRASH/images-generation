...
//事件回调函数：屏幕选点
void pointPickingCallback(const pcl::visualization::PointPickingEvent&, void*);
...
int main(int argc, char** argv) {
    ...
    viewer->registerPointPickingCallback(pointPickingCallback, (void*)&has_picked_point);
...
long minutes = (duration_sec % 3600) / 60;
long seconds = duration_sec % 60;
